(function(){
  ...
  module.exports = function(config){
    ...
    this.subscriptionUsage = {
      listByAddon: function(uuid, addoncode, status, callback){
        status = status || "all";
        t.request(utils.addParams(routes.subscriptionUsage.listByAddon, {
          uuid: uuid,
          add_on_code: addoncode,
      ...
      log: function(uuid, addoncode, details, callback){
        t.request(utils.addParams(routes.subscriptionUsage.log, {
          uuid: uuid,
          add_on_code: addoncode
        }), callback, new Js2xml('usage', details).toString());
      },
      get: function(uuid, addoncode, usageID, callback){
        t.request(utils.addParams(routes.subscriptionUsage.get, {
          uuid: uuid,
          add_on_code: addoncode,
          usage_id: usageID
        }), callback);
      ...
      update: function(uuid, addoncode, usageid, details, callback){
        t.request(utils.addParams(routes.subscriptionUsage.update, {
          uuid: uuid,
          add_on_code: addoncode,
          usage_id: usageid
        }), callback, new Js2xml('usage', details).toString());
      ...
      remove: function(uuid, addoncode, usageid, callback){
        t.request(utils.addParams(routes.subscriptionUsage.remove, {
          uuid: uuid,
          add_on_code: addoncode,
          usage_id: usageid
        }), callback);
